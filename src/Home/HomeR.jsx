...
const HomeR = () => {
    ...
    return (
        <>
            <div onClick={handleImgClick} onMouseEnter={handleimgHover} onMouseLeave={handleimgHover} className='homeR w-[50%] z-20 relative flex justify-center items-center'>
